...
map.getView().fit([-5728858.804381, -3528087.264603, -5685820.998964, -3507563.324065], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Dados geoespacias sobre áreas de risco</h2>';
        return titleElement;
    })(),
